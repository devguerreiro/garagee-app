  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          "bg-primary text-white hover:bg-primary hover:text-white focus:bg-primary focus:text-white rounded-l-md rounded-r-md",
        today: "bg-secondary text-text rounded-l-md rounded-r-md",
        outside:
        ...
        range_middle: "aria-selected:bg-primary aria-selected:text-white",
        hidden: "invisible",
        ...classNames,
      }}
      components={{
    ...
    return (
      <div className="flex h-10 items-center">
        ...
        >
          <SelectTrigger
            ref={ref}
            className="w-[65px] focus:bg-primary focus:text-white"
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          "w-[48px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-primary focus:text-white [&::-webkit-inner-spin-button]:appearance-none",
          className
        )}
...
>(
  (
    ...
    return (
      <Popover>
        <PopoverTrigger asChild disabled={disabledInput}>
          <Button
            variant="outline"
            className={cn(
